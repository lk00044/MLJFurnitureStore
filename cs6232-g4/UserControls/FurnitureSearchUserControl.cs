...
namespace cs6232_g4.UserControls
{
    ...
    public partial class FurnitureSearchUserControl : UserControl
    {
        ...
        private void FurnitureSearchUserControl_Load_1(object sender, EventArgs e)
        {
        ...
        private void furnitureIDComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(selected))
                {
                    ...
                    {
                        this.InformationLabel.Text = "No furniture with that ID. ";
                        this.ShowFurniture();
                        this.resetComboBoxes();
                    }
        ...
        private void furnitureCategoriesComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(selected))
                {
                    ...
                    {
                        this.InformationLabel.Text = "No furniture in that category. ";
                        this.ShowFurniture();
                        this.resetComboBoxes();
                    }
                }
        ...
        private void furnitureStyleComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(selected))
                {
                    ...
                    {
                        this.InformationLabel.Text = "No furniture with that Style. ";
                        this.ShowFurniture();
                        this.resetComboBoxes();
                    }
                }
        ...
        {
            this.ClearFurnitureGrid();
        }

        /// <summary>
        /// Clears the furniture grid.
        /// </summary>
        public void ClearFurnitureGrid()
        {
            this.FurnitureDataGridView.DataSource = null;
            this.InformationLabel.Text = string.Empty;
        }
